...
<template>
    <view class="mb-19.08rpx rd-7.63rpx bg-#ffffff">
        ...
        <view class="flex flex-wrap p-[19.08rpx_38.17rpx_38.17rpx] text-19.08rpx c-#ffffff lh-26.72rpx -m-4.77rpx">
            ...
            <view class="m-4.77rpx rd-19.08rpx bg-primary6/10 px-19.08rpx c-primary6">
                {{ formatDate(new Date(form?.contact?.createTime), "yyyy年MM月dd日") }} 建立信息
            </view>
            <view class="m-4.77rpx rd-19.08rpx bg-primary6/10 px-19.08rpx c-primary6">
                {{ formatDate(new Date(form?.contact?.modifyTime), "yyyy年MM月dd日") }} 更新信息
            </view>
    ...
    <view v-if="form?.contact?.phones?.some(e => e.phone)" class="mb-19.08rpx rd-7.63rpx bg-#ffffff">
        <view class="flex items-center p-[19.08rpx_38.17rpx_0]">
            <view class="h-19.08rpx w-3.82rpx bg-primary6" />
            <view class="ml-19.08rpx text-22.90rpx c-primary6 lh-38.17rpx">联系方式</view>
        </view>
        <view class="px-38.17rpx">
            <view
            ...
            >
                <view class="flex items-center lh-38.17rpx">
                    ...
                    <view class="i-mdi:email-outline size-38.17rpxrpx ml-auto c-primary6/50" @click="onSendSms(item)" />
                    <view
    ...
    <view class="rd-7.63rpx bg-#ffffff">
        ...
        <view
            ...
            class="p-[19.08rpx_38.17rpx]"
        >
            <wd-cell-group title-width="95.42rpx" value-align="left">
                <wd-cell title="企业名称">
                    <view class="flex items-center">
                        <view>{{ form?.contact?.companyName }}</view>
                        <view class="ml-9.54rpx rd-3.82rpx bg-#F95585 px-9.54rpx text-19.08rpx c-#ffffff lh-26.72rpx">
                            停业
                        </view>
                    </view>
                </wd-cell>
