...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { _, _2, _3, _4, _5, _ContactNoteResponseDTO_, _ContactOverviewResponseDTO_, _ContactPageResponseDTO_, _ContactResponseDTO_, _DTO, _DTO2, _FinanceRecordPageResponseDTO_, _FinanceRecordResponseDTO_, _FinanceTypeResponseDTO_, _HashMap_, _List_, _List_ContactNoteResponseDTO_, _List_ContactResponseDTO_, _List_DistrictLevelDto_, _List_FinanceRecordResponseDTO_, _List_FinanceTypeResponseDTO_, _List_NotebookResponseDTO_, _NotebookResponseDTO_, _PurchaserResponseDTO_, _string_, _token, _token_, _Void_, ContactDTO, ContactFinanceStatsDTO, ContactListStatsDTO, ContactNoteDTO, ContactNoteResponseDTO, ContactOverviewResponseDTO, ContactPageResponseDTO, ContactPhoneDTO, ContactResponseDTO, DistrictLevelDto, FinanceRecordDTO, FinanceRecordPageResponseDTO, FinanceRecordResponseDTO, FinanceTypeDTO, FinanceTypeResponseDTO, NotebookDTO, NotebookResponseDTO, NotebookUpdateDTO, PurchaserResponseDTO } from '../api/globals.d'
